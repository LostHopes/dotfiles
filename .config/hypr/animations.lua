...
-- Must enable animations globally first via hl.config()
hl.config({
    animations = {
        enabled = true,
    },
...
-- ─────────────────────────────────────────────────────────────────────
-- Animations
-- hl.animation({ leaf = NAME, enabled = BOOL, speed = FLOAT, bezier = STRING [, style = STRING] })
-- speed is in deciseconds: 1ds = 100ms
-- ─────────────────────────────────────────────────────────────────────
